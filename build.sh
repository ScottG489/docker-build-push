...
GIT_REPO_URL=$(echo -n $1 | jq -r .GIT_REPO_URL | base64 --decode)
RELATIVE_SUB_DIR=$(echo -n $1 | jq -r .RELATIVE_SUB_DIR | base64 --decode)
DOCKER_IMAGE_NAME=$(echo -n $1 | jq -r .DOCKER_IMAGE_NAME | base64 --decode)
